...
if(isset($_POST['submit']) && $_SERVER['REQUEST_METHOD'=="POST"]){ // Vérifie si le formulaire a été soumis
    $titre = $_POST['titre'];
    ...
    $etape = $_POST['etape'];
    $Astuce = $_POST['Astuce'];
    // Convertit le tableau d'options sélectionnées en une chaîne de caractères
    ...
    $resultat = mysqli_query($connection, $sql) or die('Erreur SQL !'.$sql.'<br>'.mysqli_error($connection));
    
    // Vérification si la requête a réussi
    if ($resultat) {
        echo "<script>alert('Votre recette a été enregistrée avec succès ! Nous allons la publier le plut tot possible') ;</script>" ;
        echo "<script>window.open('popup.php', 'popup', 'width=300,height=200'); window.location.href='principale.php';</script>";
    } else {
        echo "<script>alert('Une erreur est survenue lors de l'enregistrement de votre recette');</script>";
    }
...
<body>
   <!--navclass-->
   <nav class="navbar navbar-expand-lg bg-body-tertiary py-6">
    <div class="container">
      <!--logo-->
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-12 col-md-5 col-lg-6 order-md-2">
          <!-- Image -->
          <img src="../login/assets/images/vosrecettes.png" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0 aos-init aos-animate" alt="..." data-aos="fade-up" data-aos-delay="100" width="100%">
        </div>
